...
final $typed_data.Uint8List pingDescriptor = $convert.base64Decode('CgRQaW5nEg4KAmlkGAEgASgFUgJpZA==');
@$core.Deprecated('Use heroByIdDescriptor instead')
const HeroById$json = const {
  '1': 'HeroById',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 5, '10': 'id'},
  ],
...
/// Descriptor for `HeroById`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List heroByIdDescriptor = $convert.base64Decode('CghIZXJvQnlJZBIOCgJpZBgBIAEoBVICaWQ=');
@$core.Deprecated('Use heroDescriptor instead')
const Hero$json = const {
  '1': 'Hero',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 5, '10': 'id'},
